...
from nexapptopology.tasks import handle_update_topology
...
class TestApi(
    ...
    @patch('nexapptopology.tasks.handle_update_topology.delay')
    ...
    @patch('nexapptopology.tasks.logger.warning')
