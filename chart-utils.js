...
django.jQuery(
  (function ($) {
    $(document).ready(function () {
      ...
      $(document).ready(function () {
        $("#ow-chart-export-pdf").click(function () {
          ...
          // Fetch data from API
          $.getJSON(`${apiUrl}?${$.param(queryParams)}`, function (data) {
            ...
            doc.text("Monitoring Data Export", 14, 10);
            ...
            // Ask user whether to download or open in new tab
            const userChoice = confirm(
              "Click OK to open in a new tab, Cancel to download."
            );
